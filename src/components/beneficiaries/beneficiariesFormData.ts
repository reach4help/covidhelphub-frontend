...
const EXAMPLE_PROGRAM_DETAILS: FormField[] = [
...

  {
    ...
    placeholder: 'Enter canned and packaged goods',
  },
  {
    type: 'text',
    name: 'freezers',
    label: 'Freezer/Refrigerated goods',
    placeholder: 'Enter freezer/refrigerated goods',
  },
  {
    type: 'text',
    name: 'fruits',
    label: 'Fruits and vegetables',
    placeholder: 'Enter fruits and vegetables',
  },
  {
    type: 'text',
    name: 'diary',
    label: 'Dairy and eggs',
    placeholder: 'Enter dairy and eggs',
  },
  {
    type: 'text',
    name: 'meat',
  ...
  },
  {
    ...
    placeholder: 'Enter yougurt, tea, coffee',
  },
  {
    type: 'text',
    name: 'others',
